  ...
  <div id="allSampleContent" class="p-4 w-full">
    ...
    <script id="code">
      ...
      function save() {
        ...
        saveModel(trytest.substring(42, lastletter));
    ...
    <div id="sample">
      <div id="myDiagramDiv" style="background-color:   rgb(247, 179, 62); border: 1px solid black; height: 570px; position: relative; cursor: auto; font: 12pt Segoe UI, sans-serif;"><canvas tabindex="0" style="position: absolute; top: 0px; left: 0px; z-index: 2; user-select: none; touch-action: none; width: 1054px; height: 551px; cursor: auto;" width="1054" height="551">This text is displayed if your browser does not support the Canvas HTML element.</canvas>
        <div style="position: absolute; overflow: auto; width: 1054px; height: 568px; z-index: 1;">
          <div style="position: absolute; width: 1586.24px; height: 1px;"></div>
        </div><textarea style="position: absolute; z-index: 100; font-style: inherit; font-variant: inherit; font-weight: inherit; font-stretch: inherit; font-size: 100%; line-height: normal; font-family: inherit; font-size-adjust: inherit; font-kerning: inherit; font-optical-sizing: inherit; font-language-override: inherit; font-feature-settings: inherit; font-variation-settings: inherit; width: 97.5833px; left: 183px; top: 429px; text-align: start; margin: 0px; padding: 1px; border: 0px none; outline: none; white-space: pre-wrap; overflow: hidden;" rows="1" class="goTXarea"></textarea>
      </div>
      <div>
        <p id="msg"></p> <br>
        Edit details:<br>
      ...
      <div>
        <div>
          <button id="SaveButton" class="btn btn-primary" onclick="save()">Save</button>
          <button onclick="load()" hidden>Load</button>
          Diagram will be saved in your account.
        </div>
        <textarea id="mySavedModel" style="width:100%; height:270px;" hidden>{ "class": "go.TreeModel",
  "nodeDataArray": [
{"key":1, "name":"Stella Payne Diaz", "title":"CEO", "pic":"1.jpg", "comments":"", "parent":""}
 ]
}
    </textarea>
      </div>
