...
<html lang="fr">
    ...
    if (isset($_POST['add'])) {
        ...
        $q="UPDATE administrateur SET name='$nom', surname='$prenom' ,  password='$password',telephone='$telephone' where id=$id";
        //echo($q);echo($q);
        $db->exec($q);  
    }
    ?>
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-5">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    <div class="card-header"><h3 class="text-center font-weight-light my-4">Modifier un Administrateur</h3></div>
                                    <div class="card-body">
                                        <form method="post">
                                        <?php
                                            include_once '../database.php';
